/*Discalimer: This contents in this file belongs to the apache log4net project. I made a few modifications to make it
 work with aspnet core*/
...
namespace LongRunningActions.LogForNet
{
    /// <summary>
	...
	public class AdoNetAppender : BufferingAppenderSkeleton
    {
        ...
        virtual protected Type ResolveConnectionType()
        {
            try
            {
                //return SystemInfo.GetTypeFromString(GetType(), ConnectionType, true, false);
